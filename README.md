About openff-qcsubmit-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/openff-qcsubmit-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/openff-qcsubmit-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add openff-qcsubmit
# for installing globally
pixi global install openff-qcsubmit
```
...
It is possible to list all of the versions of `openff-qcsubmit` available on your platform:
...
```
pixi search openff-qcsubmit --channel conda-forge
```
